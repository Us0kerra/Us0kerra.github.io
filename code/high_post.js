...
function scenario(attackerX,attackerY,currentX,currentY){
    ...
    else if (attackerX == 1200 && attackerY == 425 && currentX == 880 && currentY == 385) {result.set("def1X",760).set("def1Y",515).set("def2X",1105).set("def2Y",360).set("def3X",1105).set("def3Y",115).set("def4X",820).set("def4Y",140).set("def5X",815).set("def5Y",120).set("atk1X",915).set("atk1Y",90).set("atk5X",880).set("atk5Y",420);}
    return result;
  }
